...
public class JsonFileTest {
    ...
    public void testParsingJson() {
        try (InputStream in = getClass().getClassLoader().getResourceAsStream("files/json/Shop.json")) {
            ...
            for (StaffJson staffJson : staff) {
                ...
                if (!staffJson.getRole().equals("Director")) assertNotNull(staffJson.getManagerId());
